...
hs.hotkey.bind(hammerSpoonKey, "Y", function() hs.application.open('/Applications/Weiyun.app') end)
hs.hotkey.bind(hammerSpoonKey, "I", function() hs.application.open('/Applications/Utilities/Activity Monitor.app') end)
hs.hotkey.bind(hammerSpoonKey, "O", function() hs.application.open('/Applications/Typora.app') end)
